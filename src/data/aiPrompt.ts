...
export function buildAIPrompt(simulation: SimulationRecord) {
  ...
  return `Você é um educador financeiro especializado em finanças pessoais. 
    ...
    fale sempre em segunda pessoa ("você tem...", "sua meta..."), e traga um tom de humor, sutilmente sarcástico.
    */ Elementos e Por que é importante 
     Papel - Defina tom e consistencia
     Contexto de exibição - Evita respostas inadeqquadas para a UI
     Formato de saída - Permmite processar a resposta do código
     Schema - contrato entre prompt e código
     Críterios objetivos - Elimina ambiguiadde em campos enumerados
