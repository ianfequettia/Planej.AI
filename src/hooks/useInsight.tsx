...
export const useInsight = (id: string) => {
  ...
  const storedInsight = simulation?.insight ?? null
  ...
  useEffect(() => {
    ...
    fetchInsight(id)
  }, [id, storedInsight, insight, isLoading, error, fetchInsight])

  return { insight: storedInsight ?? insight, isLoading, error, fetchInsight }
}
